...
```json
{
  ...
  "paths": {
    "/tickets/{ticketId}/data": {
      "put": {
        ...
        "operationId": "updateTicketData",
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/TicketUpdateDataRequest"
              }
            }
          }
        },
        ...
        "responses": {
          "200": {
            "$ref": "#/components/responses/Ticket_Get"
          },
          "400": {
  ...
  "components": {
    ...
    "responses": {
      ...
      "Ticket_Get": {
        "description": "Return details of a Ticket",
        "content": {
          "application/json": {
            "schema": {
              "allOf": [
