...
Return information about the identity of the caller
...
```json
{
  ...
  "paths": {
    "/whoami": {
      "get": {
        ...
        "operationId": "whoami",
        "summary": "Info",
        "description": "Return information about the identity of the caller",
        "responses": {
          "200": {
            "$ref": "#/components/responses/System_Whoami"
          },
          "default": {
  ...
  "components": {
    ...
    "responses": {
      ...
      "System_Whoami": {
        "description": "Information about the identity of the caller",
        "content": {
          "application/json": {
            "schema": {
              "allOf": [
