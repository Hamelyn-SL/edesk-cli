...
# Create Sales Order tracking links
...
```json
{
  ...
  "paths": {
    "/sales-orders-tracking-links/{salesOrderId}": {
      "post": {
        ...
        "summary": "Create Sales Order tracking links",
        "description": "Create sales order tracking links",
        "operationId": "createSalesOrderTrackingLinks",
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/SalesOrderTrackingLinksCreateRequest"
              }
            }
          }
        },
        "parameters": [
          {
            "in": "path",
            "name": "salesOrderId",
            "description": "SalesOrder ID to create tracking links",
            "required": true,
            "schema": {
              "type": "integer",
              "format": "int64"
  ...
  "components": {
    ...
    "schemas": {
      ...
      "SalesOrder_TrackingLinkRequest": {
        "type": "object",
        "required": [
          "tracking_link"
        ],
      ...
      "SalesOrderTrackingLinksCreateRequest": {
        "type": "object",
        "properties": {
          "tracking_links": {
            "type": "array",
            ...
            "items": {
              "$ref": "#/components/schemas/SalesOrder_TrackingLinkRequest"
            }
          }
        }
      },
