    ...
    "/sales-orders": {
      "get": {
        ...
        "parameters": [
          ...
          {
            "in": "query",
            "description": "Filter by sales order ID greater than or equal to",
            "name": "filter_id_gte",
            "schema": {
              "type": "integer",
              "format": "int64"
          ...
          {
            "in": "query",
            "description": "Filter by sales order ID less than or equal to",
            "name": "filter_id_lte",
            "schema": {
              "type": "integer",
              "format": "int64"
          ...
          {
            "in": "query",
            "description": "Filter by created after date (YYYY-MM-DD, inclusive start of day in user's timezone)",
          ...
          {
            "in": "query",
            "description": "Filter by created before date (YYYY-MM-DD, inclusive end of day in user's timezone)",
        ...
        "description": "Get the list of sales orders",
        "responses": {
          "200": {
            "$ref": "#/components/responses/SalesOrder_List"
          },
          "default": {
