...
# Update Sales Order tracking links
  ...
  "paths": {
    "/sales-orders-tracking-links/{salesOrderId}": {
      "put": {
        ...
        "summary": "Update Sales Order tracking links",
        "description": "Update sales order tracking links",
        "operationId": "updateSalesOrderTrackingLinks",
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
        ...
        "parameters": [
          {
            "in": "path",
            "name": "salesOrderId",
            "description": "SalesOrder ID to update tracking links",
            "required": true,
            "schema": {
              "type": "integer",
              "format": "int64"
