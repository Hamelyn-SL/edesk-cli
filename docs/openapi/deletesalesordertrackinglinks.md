...
# Delete sales order tracking links
  ...
  "paths": {
    "/sales-orders-tracking-links/{salesOrderId}": {
      "delete": {
        ...
        "operationId": "deleteSalesOrderTrackingLinks",
        "summary": "Delete sales order tracking links",
        "description": "Delete sales order tracking links",
        "parameters": [
          {
            "in": "path",
            "name": "salesOrderId",
            "description": "Sales Order ID to delete tracking links",
            "required": true,
            "schema": {
              "type": "integer",
              "format": "int64"
