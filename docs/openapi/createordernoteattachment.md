...
# Create Order Note Attachment

Create a new order note attachment
...
```json
{
  ...
  "paths": {
    "/order-notes/{orderNoteId}/attachments": {
      "post": {
        "tags": [
          "Order Notes"
        ],
        "summary": "Create Order Note Attachment",
        "description": "Create a new order note attachment",
        "operationId": "createOrderNoteAttachment",
        "parameters": [
          {
            "in": "path",
            "name": "orderNoteId",
            "description": "Order Note ID to attach",
            "required": true,
            "schema": {
              "type": "integer",
              "format": "int64"
        ...
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/OrderNoteCreateFileRequest"
              }
            },
            "multipart/form-data": {
              "schema": {
                "$ref": "#/components/schemas/OrderNoteCreateAttachmentRequest"
              }
            }
          }
        },
  ...
  "components": {
    ...
    "schemas": {
      ...
      "OrderNoteCreateAttachmentRequest": {
        "type": "object",
        "properties": {
          "attachments": {
            "$ref": "#/components/schemas/Base_AttachmentRequest"
          }
        }
      },
      "OrderNoteCreateFileRequest": {
        "type": "object",
        "properties": {
          "files": {
            "$ref": "#/components/schemas/Base_AttachmentRequestFiles"
          }
        }
      },
      "Base_AttachmentRequestFiles": {
        "type": "array",
        "properties": {
          "name": {
            "type": "string"
      ...
      "Base_AttachmentRequest": {
        ...
        "properties": {
          "name": {
            ...
            "items": {
              "type": "string",
              "description": "The name of the attachment. This is used to identify the attachment when uploading it.",
              "example": "cat.jpg"
            }
          },
          "type": {
            ...
            "items": {
              "type": "string",
              "description": "The MIME type of the attachment. See https://developer.mozilla.org/en-US/docs/Web/HTTP/Basics_of_HTTP/MIME_types",
              "example": "image/jpeg"
            }
          },
          "tmp_name": {
            ...
            "items": {
              "type": "string",
              "description": "The temporary name of the attachment. This is used to identify the attachment when uploading it.",
              "example": "/tmp/phpGwzyCN"
            }
          }
        }
      },
